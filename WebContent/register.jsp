...
<title>注册</title>
<link href="css/premium/bootstrap.min.css" rel="stylesheet">
...
<body class="bgf4">
	<nav class="navbar navbar-default" style="padding: 0 10%;">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="toMain" style="padding: 5px 30px 5px 5px;"><img src="img/core-img/logo.png" style="display: block;"/></a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="#">注册面板 <span class="sr-only">(current)</span></a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="toMain">返回主页</a></li>
            <li><a href="login.jsp">返回登录页面</a></li>
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
	  ...
	  <div class="alert alert-danger col-center col-lg-10" style="display: none;" id='alertMessage' role="alert"></div>
        	...
        	<div class="reg-box" id="verifyCheck" style="margin-top:20px;">
            	<div class="part1">                	
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" maxlength="20" class="txt03 f-r3 required" tabindex="1" data-valid="isNonEmpty||between:3-20||isUname" data-error="用户名不能为空||用户名长度3-20位||只能输入中文、字母、数字、下划线，且以中文或字母开头||该用户名已被使用" id="adminNo" />                            <span class="ie8 icon-close close hide"></span>
                            <label class="icon-sucessfill blank hide"></label>
                            <label class="focus"><span>3-20位，中文、字母、数字、下划线的组合，以中文或字母开头</span></label>
                            <label class="focus valid" id="userNameValidLable"></label>
                        </div>
                    </div>
                    <div class="item col-xs-12">
                        <span class="intelligent-label f-fl"><b class="ftx04">*</b>邮箱：</span>    
                        <div class="f-fl item-ifo">
                            <input type="text" class="txt03 f-r3 required" keycodes="tel" tabindex="2" data-valid="isNonEmpty||isPhone" data-error="邮箱不能为空||邮箱格式不正确" maxlength="30" id="adminEmail" /> 
                            <span class="ie8 icon-close close hide"></span>                           
                            <label class="icon-sucessfill blank hide"></label>
                            <label class="focus">请填有效的邮箱</label>
                    ...
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            ...
                            <label class="f-size12 c-999 f-fl f-pl10">
                            	  <canvas id="canvas" width="90px" height="40px" style="position: absolute; margin-top: -25px; "></canvas>
                            </label>                        
                            <label class="icon-sucessfill blank hide" style="left:380px"></label>
                            <label class="focusa">看不清？<a href="javascript:;" class="c-blue" id="changecode">换一张</a></label>   
                ...
                <div class="part2" style="display:none">
                    ...
                    <div class="item col-xs-12 f-mb10" style="height:auto">
                        ...
                        <div class="f-fl item-ifo c-blue" id='emailHolder'>
                        </div>
                    </div>
                    <div class="item col-xs-12">
                        <span class="intelligent-label f-fl"><b class="ftx04">*</b>验证码：</span>    
                        <div class="f-fl item-ifo">
                            <input type="text" maxlength="6" id="verifyNo" class="txt03 f-r3 f-fl required" tabindex="4" style="width:167px" data-valid="isNonEmpty||isInt" data-error="验证码不能为空||请输入6位数字验证码" /> 
                           	<span class="btn btn-gray f-r3 f-ml5 f-size13" id="time_box" disabled style="width:93px;display:none;">发送验证码</span>
                            <span class="btn btn-gray f-r3 f-ml5 f-size13" id="verifyYz" style="width:93x;">发送验证码</span>
                            <span class="ie8 icon-close close hide" style="right:130px"></span>
                            <label class="icon-sucessfill blank hide"></label>
                            <label class="focus"><span>请查收邮箱，并填写邮箱中的验证码（此验证码3分钟内有效）</span></label>   
                            <label class="focus valid"></label>                        
                        </div>
                    </div>
                    <div class="item col-xs-12">
                ...
                <div class="part3" style="display:none">
                    ...
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" class="txt03 f-r3 required" tabindex="2" data-valid="isNonEmpty||isCard" data-error="身份证号不能为空||身份证号码格式不正确" maxlength="18" id="idCardNum" />    
                            <span class="ie8 icon-close close hide"></span>                        
                            <label class="icon-sucessfill blank hide"></label>
                            <label class="focus">请填写正确的身份证号码</label>
                            <label class="focus valid"></label>
                        </div>
                    </div>
                    <div class="item col-xs-12">
                ...
                <div class="part4 text-center" style="display:none">
                	<h3>恭喜<span id="adminNoShow"></span>，您已注册成功，现在开始分享您的校园生活吧！</h3>
                    <p class="c-666 f-mt30 f-mb50">页面将在 <strong id="times" class="f-size18">10</strong> 秒钟后，跳转到 <a href="login.html" class="c-blue">用户中心</a></p>
                </div>          
            </div>
        </div>
    </div>
...
$(function(){	
	...
	$("#adminNo").blur(function(){
		$.post({
			...
			success:function(data){
				...
				{
					uniqueUserName=true;
					$("#userNameValidLable").html("输入的用户名已存在");
					$("#userNameValidLable").toggleClass("error");
				}else{
					uniqueUserName=true;
				}
			}
	...
	$("#btn_part1").click(function(){						
		...
		if(rancode!=$("#randCode").val())
		{
			$("#alertMessage").html("您输入的验证码有误请重新输入");
			$("#alertMessage").fadeToggle(1000,function(){
				$("#alertMessage").fadeToggle(3000);
			});
			 return false;
		}
		...
		$("#verifyYz").click();
		$("#emailHolder").html($("#adminEmail").val());
		$.post({
			url:"mailverify",
			data:{
				receiveEmail:$("#adminEmail").val()
			},
			success:function(data){
				server_rancode=data;
			}
	...
	$("#btn_part2").click(function(){			
		if(!verifyCheck._click()) return;
		if($("#verifyNo").val()!=server_rancode)
		{
			$("#alertMessage").html("您输入的验证码有误请重新输入");
			$("#alertMessage").fadeToggle(2000,function(){
				$("#alertMessage").fadeToggle(2000);
			});
